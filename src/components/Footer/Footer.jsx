  ...
  return (
    <footer className="footer p-10 rounded-xl bg-gradient-to-r from-indigo-200 from-10% via-sky-200 via-30% to-emerald-200 to-90% text-base-content">
      ...
      <div>
        ...
        <p>
          Address: H23G+98J, <br /> Ayala Ave, Legazpi Village, <br /> Makati,
          1229 Metro Manila, <br /> Philippines
        </p>
      </div>
      <div>
        <div className="footer-title">Social Media</div>
        <div className="flex gap-4">
          <Link to="https://www.facebook.com/" className="text-3xl">
            <FaFacebookSquare></FaFacebookSquare>
          </Link>
          <Link to="https://www.twiter.com/" className="text-3xl">
            <FaTwitterSquare></FaTwitterSquare>
          </Link>
          <Link to="https://www.linkedin.com/" className="text-3xl">
