...
const Gallery = () => {
  ...
  return (
    <div className="py-10">
      <div className="px-5">
        <p className="text-5xl font-bold text-center underline bg-gradient-to-r from-indigo-200 from-10% via-sky-500 via-30% to-emerald-200 to-90% py-4 rounded-2xl">Gallery</p>
      ...
      <div className="lg:flex justify-between gap-4">
        <div className="mockup-phone" data-aos="fade-up" data-aos-anchor-placement="ease-in-cubic">
        ...
        <div className="mockup-phone" data-aos="zoom-in-right" data-aos-anchor-placement="slide-up" data-aos-duration="600">
        ...
        <div className="mockup-phone" data-aos="zoom-in-right" data-aos-anchor-placement="ease-in-cubic" data-aos-duration="600">
        ...
        <div className="mockup-phone" data-aos="fade-zoom-in" data-aos-offset="200" data-aos-easing="ease-in-sine" data-aos-duration="600">
