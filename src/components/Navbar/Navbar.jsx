...
const Navbar = () => {
  ...
  return (
    <div className="rounded-xl navbar px-10 bg-gradient-to-r from-indigo-200 from-10% via-sky-200 via-30% to-emerald-200 to-90%">
  <div className="navbar-start">
    ...
    <div className="text-center flex-col"><a className="btn btn-ghost normal-case text-3xl font-bold">Hublot Toys</a> <br /> <small>Entertaining kids since 1886</small></div>
  </div>
